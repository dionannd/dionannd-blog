...
<Image
  ...
  src={"/speeding-up-wsl2-network-up-than-5x-fast/network.png"}
  width={680}
  height={115}
/>
...
1. Press the Windows Key and type “Control Panel” -> “Network and Internet” -> “View network status and tasks”
   ...
   <Image
     ...
     src={"/speeding-up-wsl2-network-up-than-5x-fast/network-and-sharing.webp"}
     width={645}
     height={120}
   />
...
2. Click “Change adapter settings”
   ...
   <Image
     ...
     src={"/speeding-up-wsl2-network-up-than-5x-fast/adapter-setting.png"}
     width={183}
     height={126}
   />
...
3. Find the “vEthernet (WSL)” adapter and click properties
   ...
   <Image
     ...
     src={"/speeding-up-wsl2-network-up-than-5x-fast/vethernet-wsl.webp"}
     width={489}
     height={273}
   />
...
4. Click “configure” and open the advanced tab
   ...
   <Image
     ...
     src={
       "/speeding-up-wsl2-network-up-than-5x-fast/vethernet-adapter-properties.webp"
     }
     width={394}
     height={453}
   />
...
<Image
  ...
  src={"/speeding-up-wsl2-network-up-than-5x-fast/network-speed-fix.png"}
  width={467}
  height={68}
/>
